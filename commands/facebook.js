...
// ============================================
// ENHANCEMENT: Helper function for stylish messages with fancy font
// ============================================
function formatFacebookMessage(title, content, type = 'info') {
    const emojis = {
        info: 'ℹ️',
        success: '✅',
        warning: '⚠️',
...
async function facebookCommand(sock, chatId, message) {
    try {
        ...
        if (!url) {
            ...
            const usageMsg = formatFacebookMessage(
                'FACEBOOK DOWNLOADER',
                `│ 📥 *Usage:*\n│ ♧ .fb <facebook-url>\n│\n│ *Example:*\n│ ♧ .fb https://fb.com/watch?v=123`,
                'download'
            );
        ...
        if (!url.includes('facebook.com')) {
            ...
            const invalidMsg = formatFacebookMessage(
                'INVALID LINK',
        ...
        if (!fbvid) {
            ...
            const errorMsg = formatFacebookMessage(
                'DOWNLOAD FAILED',
        ...
        try {
            const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 BATMAN MD\n\n📝 𝙏𝙞𝙩𝙡𝙚: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 BATMAN MD";
