...
// ============================================
function formatWelcomeMessage(title, content, type = 'info') {
    const emojis = {
        info: 'ℹ️',
        success: '✅',
        warning: '⚠️',
...
async function welcomeCommand(sock, chatId, message, match) {
    ...
    if (!chatId.endsWith('@g.us')) {
        ...
        const groupOnlyMsg = formatWelcomeMessage(
            'GROUP ONLY',
    ...
    for (const participant of participants) {
        try {
            ...
            if (customMessage) {
                ...
                // ENHANCEMENT: Stylish default welcome message
...
> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʙᴀᴛᴍᴀɴ ᴍᴅ*`;
            ...
            if (customMessage) {
                ...
                // ENHANCEMENT: Stylish fallback message
